...
public class ApplicationConstants {
    ...
    public static final String YTDLP_PATH = "ytDlp_path";
    ...
    public static final String YT_DLP_DOWNLOAD_URL = "https://github.com/yt-dlp/yt-dlp/releases/latest/download/yt-dlp";
    public static final String YT_DLP_DOWNLOAD_UR_WIN = "https://github.com/yt-dlp/yt-dlp/releases/latest/download/yt-dlp.exe";
    ...
    public static String getYtDLPBinaryNameBasedOnOs() {
    ...
    public static String getYtDLPDownloadUrlBasedOnOs() {
        if (System.getProperty(OS_NAME).toLowerCase().contains("win")) {
            return YT_DLP_DOWNLOAD_UR_WIN;
        }
        return YT_DLP_DOWNLOAD_URL;
    }
